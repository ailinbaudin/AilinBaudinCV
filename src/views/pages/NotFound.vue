...
<template>
    <svg viewBox="0 0 960 540" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" class="min-h-screen min-w-screen fixed left-0" :style="{ bottom: '-10rem' }" preserveAspectRatio="none">
